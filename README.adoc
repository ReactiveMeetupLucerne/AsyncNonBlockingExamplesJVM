...
| Scala
| scala-futures
| link:./src/main/scala/challenge1/challenge2/scala_futures/ScalaFutureExample.scala[]
link:./src/main/scala/challenge1/challenge2/scala_futures/ScalaFutureMoreCallsExample.scala[]
